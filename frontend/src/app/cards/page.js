      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {cards.map((card, i) => {
            ...
            return (
              <BorderGlow key={card.id} animated={true} borderRadius={20} glowRadius={30} edgeSensitivity={20} backgroundColor="transparent" style={{ width: "100%", height: "100%" }}>
...
export default function CardsPage() {
  return (
    <Suspense fallback={<SidebarLayout><div style={{ display: "flex", height: "60vh", alignItems: "center", justifyContent: "center" }}>Loading...</div></SidebarLayout>}>
      <CardsPageContent />
    </Suspense>
  )
}